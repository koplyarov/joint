...
#define DETAIL_JOINT_C_DEFINE_ARRAY(Name_, CppType_, JointType_, GetCode_, SetCode_) \
    ...
    JOINT_CORE_WARN_UNUSED_RESULT(JointCore_Error) Name_##__Array_Create(size_t size, Name_##__Array* array, JointCore_Exception_Handle* ex) \
    { \
        JointCore_Type t; \
        t.id = JointType_; \
    ...
    JOINT_CORE_WARN_UNUSED_RESULT(JointCore_Error) Name_##__Array_GetSize(Name_##__Array array, size_t* result, JointCore_Exception_Handle* ex) \
    { \
    ...
    JOINT_CORE_WARN_UNUSED_RESULT(JointCore_Error) Name_##__Array_Get(Name_##__Array array, size_t index, CppType_* result, JointCore_Exception_Handle* ex) \
    { \
    ...
    JOINT_CORE_WARN_UNUSED_RESULT(JointCore_Error) Name_##__Array_Set(Name_##__Array array, size_t index, CppType_ value, JointCore_Exception_Handle* ex) \
    { \
