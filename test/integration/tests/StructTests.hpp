...
public:
	...
	test::S1 MakeS1(int32_t i, joint::StringRef s) { return test::S1(i, joint::String(s)); }
	joint::String GetSFromS1(test::S1 s) { return s.s; }
	int32_t GetIFromS1(test::S1 s) { return s.i; }

	test::S2 MakeS2(int32_t i, test::S2L s2l, float f, test::S2M s2m, joint::StringRef s, test::S2R s2r) { return test::S2(i, s2l, f, s2m, joint::String(s), s2r); }
	...
	joint::String GetSFromS2(test::S2 s) { return s.s; }
...
TEST_DEFINE_TEST(TestCtx, StructTests)
{
	...
	TEST_EQUALS(t->MakeS1(42, "abc").s, joint::String("abc"));
	TEST_EQUALS(t->GetIFromS1(S1(42, "abc")), 42);
	TEST_EQUALS(t->GetSFromS1(S1(42, "abc")), joint::String("abc"));

	auto cb = Ctx.MakeComponent<IStructTestsCallback, StructTestsCallback>();
	TEST_EQUALS(t->CallbackMakeS1(cb, 42, "abc").i, 42);
	TEST_EQUALS(t->CallbackMakeS1(cb, 42, "abc").s, joint::String("abc"));
	TEST_EQUALS(t->CallbackGetIFromS1(cb, S1(42, "abc")), 42);
	TEST_EQUALS(t->CallbackGetSFromS1(cb, S1(42, "abc")), joint::String("abc"));
	...
	TEST_EQUALS(s2.s, joint::String("abc"));
	TEST_EQUALS(s2.s2r.s, joint::String("qwe"));
	...
	TEST_EQUALS(t->GetSFromS2(s2), joint::String("abc"));
	TEST_EQUALS(t->GetS2RFromS2(s2).s, joint::String("qwe"));
	...
	TEST_EQUALS(s2.s, joint::String("AAA"));
	TEST_EQUALS(s2.s2r.s, joint::String("ZZZ"));
	...
	TEST_EQUALS(t->CallbackGetSFromS2(cb, s2), joint::String("AAA"));
	TEST_EQUALS(t->CallbackGetS2RFromS2(cb, s2).s, joint::String("ZZZ"));
}
