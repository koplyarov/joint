...
extern "C"
{
    ...
    JointCore_Error JointCore_Exception_Create(const char* message, const JointCore_Exception_BacktraceEntry* backtrace, JointCore_SizeT backtraceSize, JointCore_Exception_Handle* outException)
    {
        ...
        JOINT_DEVKIT_CHECK(outException, JOINT_CORE_ERROR_INVALID_PARAMETER);
    ...
    JointCore_Error JointCore_Exception_GetMessage(JointCore_Exception_Handle ex, const char** outMessagePtr)
    {
        ...
        JOINT_DEVKIT_CHECK(ex != JOINT_CORE_NULL_HANDLE, JOINT_CORE_ERROR_INVALID_PARAMETER);
    ...
    JointCore_Error JointCore_Exception_AppendBacktrace(JointCore_Exception_Handle ex, JointCore_Exception_BacktraceEntry entry)
    {
        ...
        JOINT_DEVKIT_CHECK(ex != JOINT_CORE_NULL_HANDLE, JOINT_CORE_ERROR_INVALID_PARAMETER);
        JOINT_DEVKIT_CHECK(entry.module, JOINT_CORE_ERROR_INVALID_PARAMETER);
        JOINT_DEVKIT_CHECK(entry.filename, JOINT_CORE_ERROR_INVALID_PARAMETER);
        JOINT_DEVKIT_CHECK(entry.code, JOINT_CORE_ERROR_INVALID_PARAMETER);
        JOINT_DEVKIT_CHECK(entry.function, JOINT_CORE_ERROR_INVALID_PARAMETER);
    ...
    JointCore_Error JointCore_Exception_GetBacktraceSize(JointCore_Exception_Handle ex, JointCore_SizeT* outSize)
    {
        ...
        JOINT_DEVKIT_CHECK(ex != JOINT_CORE_NULL_HANDLE, JOINT_CORE_ERROR_INVALID_PARAMETER);
        JOINT_DEVKIT_CHECK(outSize != JOINT_CORE_NULL_HANDLE, JOINT_CORE_ERROR_INVALID_PARAMETER);
    ...
    JointCore_Error JointCore_Exception_GetBacktraceEntry(JointCore_Exception_Handle ex, JointCore_SizeT index, JointCore_Exception_BacktraceEntry* outEntry)
    {
        ...
        JOINT_DEVKIT_CHECK(ex != JOINT_CORE_NULL_HANDLE, JOINT_CORE_ERROR_INVALID_PARAMETER);
        JOINT_DEVKIT_CHECK(index < ex->Backtrace().size(), JOINT_CORE_ERROR_INVALID_PARAMETER);
        JOINT_DEVKIT_CHECK(outEntry != JOINT_CORE_NULL_HANDLE, JOINT_CORE_ERROR_INVALID_PARAMETER);
