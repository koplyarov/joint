...
if (JOINT_GEN_FOUND)
	...
	if (JOINT_COVERAGE)
		set(__JOINT_PRIVATE_GEN_BINARY COVERAGE_FILE=${PYTHON_COVERAGE_RESULT} python-coverage run --rcfile ${PYTHON_COVERAGERC} -a ${JOINT_GEN_SCRIPT})
	else()
	...
	macro(JOINT_MAKE_MODULE_PACKAGE TARGET_NAME)
		...
		add_custom_command(
			...
			COMMAND ${CMAKE_COMMAND} -E copy_if_different ${_JOINT_MMP_MANIFEST_ABS} ${_JOINT_MMP_PACKAGE_DIR}/${_JOINT_MMP_MANIFEST_BASENAME}
