...
data = {
    ...
    'java, component void()': ${basic.invoke_void_void.joint(lang:java)[main]} / ${basic.invokeNative_void_void.joint(lang:cpp)[main]},
    'java, proxy void()': ${basic.invokeOutgoing_void_void.joint(lang:java)[main]} / ${basic.invokeNative_void_void.joint(lang:cpp)[main]},
    'java, component i32()': ${basic.invoke_i32_void.joint(lang:java)[main]} / ${basic.invokeNative_i32_void.joint(lang:cpp)[main]},
    'java, proxy i32()': ${basic.invokeOutgoing_i32_void.joint(lang:java)[main]} / ${basic.invokeNative_i32_void.joint(lang:cpp)[main]},
    'java, component void(i32)': ${basic.invoke_void_i32.joint(lang:java)[main]} / ${basic.invokeNative_void_i32.joint(lang:cpp)[main]},
    'java, proxy void(i32)': ${basic.invokeOutgoing_void_i32.joint(lang:java)[main]} / ${basic.invokeNative_void_i32.joint(lang:cpp)[main]},
    'java, component string3()': ${basic.invoke_string3_void.joint(lang:java)[main]} / ${basic.invokeNative_string3_void.joint(lang:cpp)[main]},
    'java, proxy string3()': ${basic.invokeOutgoing_string3_void.joint(lang:java)[main]} / ${basic.invokeNative_string3_void.joint(lang:cpp)[main]},
    'java, component void(string3)': ${basic.invoke_void_string3.joint(lang:java)[main]} / ${basic.invokeNative_void_string3.joint(lang:cpp)[main]},
    'java, proxy void(string3)': ${basic.invokeOutgoing_void_string3.joint(lang:java)[main]} / ${basic.invokeNative_void_string3.joint(lang:cpp)[main]},
    'java, component string100()': ${basic.invoke_string100_void.joint(lang:java)[main]} / ${basic.invokeNative_string100_void.joint(lang:cpp)[main]},
    'java, proxy string100()': ${basic.invokeOutgoing_string100_void.joint(lang:java)[main]} / ${basic.invokeNative_string100_void.joint(lang:cpp)[main]},
    'java, component void(string100)': ${basic.invoke_void_string100.joint(lang:java)[main]} / ${basic.invokeNative_void_string100.joint(lang:cpp)[main]},
    'java, proxy void(string100)': ${basic.invokeOutgoing_void_string100.joint(lang:java)[main]} / ${basic.invokeNative_void_string100.joint(lang:cpp)[main]},
