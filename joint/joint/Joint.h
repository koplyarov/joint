...
#define JOINT_FALSE 0
	...
	{
		JOINT_ERROR_NONE = 0,
		JOINT_ERROR_EXCEPTION = 1,
		JOINT_ERROR_GENERIC = 2,
		JOINT_ERROR_NO_SUCH_BINDING = 3,
		JOINT_ERROR_NO_SUCH_MODULE = 4,
		JOINT_ERROR_NOT_IMPLEMENTED = 5,
		JOINT_ERROR_INVALID_PARAMETER = 6,
		JOINT_ERROR_OUT_OF_MEMORY = 7,
		JOINT_ERROR_IMPLEMENTATION_ERROR = 8,
		JOINT_ERROR_UNEXPECTED_TYPE = 9
	} Joint_Error;
